...
to introduce a texture-shape cue conflicts. \medskip \par
...
\begin{figure}[!htbp]\center
  ...
  \caption{Classification results of the colorful parachute texture and test image after training on imagenette-160.}
...
\begin{figure}[!htbp]\center
  ...
  \caption{Classification results for the English Springer after training the model on imagenette-160.}
...
\begin{figure}[!htbp]\center
  ...
  \caption{Classification results of the colorful parachute texture 
...
led to classification probabities available in Fig. \ref{stylized-imagenette-160-dog-predictions}.
...
\textbf{TODO: UPDATE IMAGE WITH THE NEW PROBABILITIES FROM LATEST MODEL}

\begin{figure}[!htbp]\center
  \includegraphics[width=0.35\textwidth]{imgs/experiment-1/stylized-imagenette-160-dog-predictions}
  \caption{Classification results for the English Springer after training the model on stylized imagenette-160.}
