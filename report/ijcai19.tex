...
\subsubsection{IN \texorpdfstring{\textrightarrow} IIN}
...
\subsubsection{IN \texorpdfstring{\textrightarrow} SSIN}
...
\subsubsection{SIN \texorpdfstring{\textrightarrow} SSIN}
...
\subsubsection{SIN \texorpdfstring{\textrightarrow} IIN}

This training scheme yields inferior results than IN \texorpdfstring{\textrightarrow} IIN, however
there are much better than IN \texorpdfstring{\textrightarrow} SSIN. 

This demonstrates that a shape-biased model generalizes better than texture biased models.

\subsection{Shape-ResNet}

\subsubsection{SIN + IN \texorpdfstring{\textrightarrow} IIN}

\subsubsection{SIN + IN + finetune(IN) \texorpdfstring{\textrightarrow} IIN}
