...
\subsection{Texture biais intuition}
...
through image classification on a stylized image. The intuition was that the textured image would be classified as 
...
\begin{figure}[h!]\centering
  ...
  \caption*{(b) Texture image: TODO GIVE NUMBERS}
\end{figure}

\begin{figure}[h!]\centering
  \includegraphics{imgs/stylized}
  \caption*{(c) Stylized image: TODO GIVE NUMBERS}
\end{figure}
