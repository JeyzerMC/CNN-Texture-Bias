...
\subsubsection{IN \textrightarrow  IN}
...
\subsubsection{IN \textrightarrow  SIN}
...
\subsubsection{SIN \textrightarrow  SIN}
...
\subsubsection{SIN \textrightarrow  IN}

This training scheme yields inferior results than IN \textrightarrow  IN, however
there are much better than IN \textrightarrow  SIN. 

This demonstrates that a shape-biased model generalizes better than texture biased models.

\subsection{Shape-ResNet}

\subsubsection{SIN + IN \textrightarrow  IN}

\subsubsection{SIN + IN + finetune(IN) \textrightarrow  IN}
