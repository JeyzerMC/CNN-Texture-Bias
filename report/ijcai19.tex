...
\textit{tench, English springer, cassette player, chain saw, church, French horn, garbage truck, gas pump, golf ball, parachute}.
...
The image created by the style transfer is called the \textbf{stylized image}. \smallskip
...
The two datasets have the same image identifiers for their testing set, only the stylization changes.
...
can be seen on Fig. \ref{dog-parachute}.
...
led to classification probabities available in Fig. \ref{stylized-dog-parachute}.
